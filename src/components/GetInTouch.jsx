    ...
    <div className="bg-[#F0F5EB] py-[71px] px-4 md:px-20 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="w-full md:w-1/2 mb-12 md:mb-0 md:ml-[90px]">
        ...
        <div className="flex items-start mb-[61px]">
          ...
          />
          <div>
            <h3 className="text-2xl font-semibold text-[#6BA85D]">
              Address
            </h3>
        ...
        {/* Phone */}
        <div className="flex items-start mb-[61px]">
          <img src={phoneIcon} alt="Phone Icon" className="w-[23px] h-[30px] mr-4" />
          <div>
            <h3 className="text-2xl font-semibold mb-1 text-[#6BA85D]">Phone</h3>
            <p className="text-[#393939] text-[19px] font-medium">+91 97523-24111</p>
          </div>
        </div>

        {/* Email */}
        <div className="flex items-start">
          <img src={emailIcon} alt="Email Icon" className="w-[30px] h-[25px] mr-4" />
          <div>
            <h3 className="text-2xl font-semibold mb-1 text-[#6BA85D]">Email</h3>
            <p className="text-[#393939] text-[19px] font-medium">hello@houseofbastar.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#6BA85D] w-full md:w-[629px] h-auto md:h-[605px] p-8 md:py-[60px] md:pl-[54px] md:pr-[39px] md:mr-[47px] rounded-lg">
        <form className="">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full p-3 px-6 rounded-lg bg-[#6BA85D] text-[#FFFFFF] border border-[#C9C9C9] placeholder:text-white mb-5"
              placeholder="Name"
            />
          </div>
