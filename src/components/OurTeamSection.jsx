...
const OurTeamSection = () => {
  return (
    <div className="relative bg-white py-16 px-4 md:px-20">
      {/* Hologram Images */}
      <img
        src={hologram1}
      ...
      {/* Team Cards */}
      <div className="flex flex-wrap justify-between items-center relative z-20">
        {/* Team Member 1 */}
        <div className="bg-[#ECF2E6] text-white w-full md:w-[312px] md:h-[357px] rounded-lg px-[13px] pt-[13px] pb-[40px] mb-6">
          ...
          />
          <h3 className="text-2xl font-semibold mb-2 text-center text-[#393939]">Ms. Katherine</h3>
          <p className="text-base font-medium text-center text-[#858585]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
        </div>
